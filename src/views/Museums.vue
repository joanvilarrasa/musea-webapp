                ...
                <table>
                    ...
                    <tbody>
                        <tr v-for="museum in this.museums" :key="museum.id">
                            ...
                            <td> <button class="delete" @click="esborrarMuseu(museum._id)"> <router-link :to="{ name: 'Museums'}"><v-img :src="require('../assets/delete-icon.png')"   width ="25px" height="25px"/></router-link></button> <button class="delete"> <router-link :to="{ name: 'MuseumEdit', params: { id_museu: museum._id, museum_nom: museum.name, museum_city: museum.city, museum_adresss: museum.address, museum_country: museum.country}}"> <v-img :src="require('../assets/edit.png')"   width ="25px" height="25px"/> </router-link></button> </td>
